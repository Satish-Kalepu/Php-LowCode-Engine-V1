	<div class="code_line" style="display: flex; gap:20px; margin-bottom: 10px;" >
			<div>
				<div>Method</div>
				<div data-type="dropdown" data-for='api' data-list="list" data-var="input-method" data-list-values="input-method" >{{ api__['input-method'] }}</div>
			</div>
			<div v-if="api__['input-method']=='POST'">
				<div>Input</div>
				<div data-type="dropdown" data-for='api' data-list="list" data-var="input-type" data-list-values="post-input-type" >{{ api__['input-type'] }}</div>
			</div>
			<div v-if="api__['input-method']=='GET'" v-on:change="save_need__=true" >
				<div>Input</div>
				<div data-type="dropdown" data-for='api' data-list="list" data-var="input-type" data-list-values="get-input-type" >{{ api__['input-type'] }}</div>
			</div>
			<div>
				<div>Output</div>
				<div data-type="dropdown" data-for='api' data-list="list" data-var="output-type" data-list-values="output-type" >{{ api__['output-type'] }}</div>
			</div>
	</div>
	<div class="code_line" style="border-bottom:1px solid #bbcccc; margin-bottom:10px;" >
		...
		<div v-if="api__['input-type']=='query_string'">
			...
			<input_object v-bind:v="engine__['input_factors']" datafor="engine" datavar="input_factors" viewas="payload" allowsub="no" v-on:edited="input_factors_edited__"></input_object>
		</div>
		<div v-if="api__['input-type']=='application/x-www-form-urlencoded'">
			<div style="font-size:14px; ">Input Post Fields: </div>
			<input_object v-bind:v="engine__['input_factors']" datafor="engine" datavar="input_factors" viewas="payload" allowsub="no" ></input_object>
		</div>
	</div>
